...
const MESSAGES: Record<Locale, Messages> = {
  en: {
    ...
    "Confirm your email to view group details.": "Confirm your email to view group details.",
    ...
    "Securing your session and balances…": "Securing your session and balances…",
  ...
  ar: {
    ...
    "No groups yet — create one under Groups": "لا توجد مجموعات بعد — أنشئ واحدة ضمن المجموعات",
    "Transactions": "المعاملات",
    "No transactions in this group yet.": "لا توجد معاملات في هذه المجموعة بعد.",
    ...
    "No groups yet — create one above.": "لا توجد مجموعات بعد — أنشئ واحدة أعلاه.",
    "Invite": "دعوة",
    ...
    "Confirm your email to use friends.": "أكد بريدك الإلكتروني لاستخدام الأصدقاء.",
    "Search by display name, pick the right person from the list, or send by email. Accept incoming requests below.":
    ...
    "Confirm your email to view group details.": "أكد بريدك الإلكتروني لعرض تفاصيل المجموعة.",
    "Pick an expense, inspect the split map, or open the whole-group balance view to see who should pay whom after every transaction and settlement.":
    ...
    "List · split map · receipt details": "قائمة · خريطة التقسيم · تفاصيل الإيصال",
    "Use {label} to show the expense list and breakdown again.":
    ...
    "Sign out everywhere on this device": "تسجيل الخروج من هذا الجهاز في كل مكان",
  ...
  fr: {
    ...
    "Left": "Reste",
    "No expense splits recorded yet.": "Aucune répartition de dépense enregistrée.",
    ...
    "Member balances and transfer map": "Soldes des membres et carte des transferts",
    "Filtered by {name}": "Filtré par {name}",
    "List · split map · receipt details": "Liste · carte de répartition · détails du reçu",
    "Use {label} to show the expense list and breakdown again.":
    ...
    "Sign out everywhere on this device": "Se déconnecter partout sur cet appareil",
    ...
    "Securing your session and balances…": "Sécurisation de votre session et de vos soldes…",
    "Update your display name and currency, and change your password.":
    ...
    "Transactions": "Transactions",
    "No transactions in this group yet.": "Aucune transaction dans ce groupe pour l’instant.",
    "Select a group to add an expense.": "Sélectionnez un groupe pour ajouter une dépense.",
    "Currency": "Devise",
    "(must match the group — set when the group was created)":
    ...
    "No groups yet — create one above.": "Aucun groupe — créez-en un ci-dessus.",
    "Invite": "Invitation",
    ...
    "Join link copied for \"{group}\".": "Lien de participation copié pour \"{group}\".",
    "Invite code copied for \"{group}\".": "Code d’invitation copié pour \"{group}\".",
    "Could not copy automatically — copy the invite code from the list.":
    ...
    "Choose another member as payee.": "Choisissez un autre membre comme bénéficiaire.",
    ...
    "Meme: Drake format about 404 pages": "Mème : format Drake sur les pages 404",
    "Admitting you typed the URL wrong": "Admettre que vous avez mal tapé l’URL",
    "Blaming inflation for a missing page (same energy)":
    ...
    "- your browser's CFO (probably)": "- le CFO de votre navigateur (probablement)",
    "Home": "Accueil",
  },
  de: {
    "English": "Englisch",
    ...
    "Left": "Übrig",
    "No expense splits recorded yet.": "Noch keine Ausgabenaufteilungen erfasst.",
    ...
    "List · split map · receipt details": "Liste · Aufteilungskarte · Belegdaten",
    "Use {label} to show the expense list and breakdown again.":
    ...
    "Securing your session and balances…": "Sitzung und Salden werden gesichert…",
    "Update your display name and currency, and change your password.":
    ...
    "No transactions in this group yet.": "Noch keine Transaktionen in dieser Gruppe.",
    "Select a group to add an expense.": "Wähle eine Gruppe, um eine Ausgabe hinzuzufügen.",
    "Currency": "Währung",
    "(must match the group — set when the group was created)":
    ...
    "Equal split ({count} member)": "Gleichmäßige Aufteilung ({count} Mitglied)",
    ...
    "No groups yet — create one above.": "Noch keine Gruppen — erstelle eine oben.",
    "Invite": "Einladung",
    ...
    "Invite code copied for \"{group}\".": "Einladungscode für \"{group}\" kopiert.",
    "Could not copy automatically — copy the invite code from the list.":
    ...
    "Choose another member as payee.": "Wähle ein anderes Mitglied als Empfänger.",
    ...
    "No one you owe in this group": "Niemand, dem du in dieser Gruppe etwas schuldest",
    ...
    "Will apply to {count} expense(s)": "Wird auf {count} Ausgabe(n) angewendet",
    ...
    "Admitting you typed the URL wrong": "Zugeben, dass du die URL falsch getippt hast",
    "Blaming inflation for a missing page (same energy)":
    ...
    "- your browser's CFO (probably)": "- der CFO deines Browsers (wahrscheinlich)",
    "Home": "Startseite",
  },
  es: {
    "English": "Inglés",
    ...
    "they owe": "deben",
    "Left": "Restante",
    "No expense splits recorded yet.": "Aún no hay repartos de gastos registrados.",
    "Accepting…": "Aceptando…",
    ...
    "Member balances and transfer map": "Saldos de miembros y mapa de transferencias",
    "Filtered by {name}": "Filtrado por {name}",
    "List · split map · receipt details": "Lista · mapa de reparto · detalles del recibo",
    "Use {label} to show the expense list and breakdown again.":
    ...
    "Sign out everywhere on this device": "Cerrar sesión en este dispositivo en todas partes",
    ...
    "No transactions in this group yet.": "Aún no hay transacciones en este grupo.",
    "Select a group to add an expense.": "Selecciona un grupo para agregar un gasto.",
    "Currency": "Moneda",
    "(must match the group — set when the group was created)":
    ...
    "Join link copied for \"{group}\".": "Enlace de unión copiado para \"{group}\".",
    "Invite code copied for \"{group}\".": "Código de invitación copiado para \"{group}\".",
    "Could not copy automatically — copy the invite code from the list.":
    ...
    "Meme: Drake format about 404 pages": "Meme: formato Drake sobre páginas 404",
    ...
    "- your browser's CFO (probably)": "- el CFO de tu navegador (probablemente)",
    "Home": "Inicio",
  },
};
