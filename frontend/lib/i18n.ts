...
const MESSAGES: Record<Locale, Messages> = {
  ...
  ar: {
    ...
    "Clarity in shared finances.": "وضوح في الشؤون المالية المشتركة.",
    "Forgot?": "نسيت؟",
    "How should we call you?": "كيف نسمّيك؟",
  ...
  fr: {
    ...
    "Clarity in shared finances.": "Clarté dans les finances partagées.",
  ...
  de: {
    ...
    Email: "E-Mail",
    Password: "Passwort",
    "Clarity in shared finances.": "Klarheit bei gemeinsamen Finanzen.",
  ...
  es: {
    ...
    Password: "Contraseña",
    "Clarity in shared finances.": "Claridad en las finanzas compartidas.",
