    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionMembers", x => new { x.TransactionId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SettlementAllocations", x => new { x.SettlementId, x.TransactionId, x.DebtorUserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SettlementAllocations_TransactionMembers_TransactionId_Debt~",
                        columns: x => new { x.TransactionId, x.DebtorUserId },
                        principalTable: "TransactionMembers",
                        principalColumns: new[] { "TransactionId", "UserId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SettlementAllocations_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SettlementAllocations_DebtorUserId",
                table: "SettlementAllocations",
                column: "DebtorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SettlementAllocations_SettlementId_DebtorUserId",
                table: "SettlementAllocations",
                columns: new[] { "SettlementId", "DebtorUserId" });

            migrationBuilder.CreateIndex(
                name: "IX_SettlementAllocations_TransactionId_DebtorUserId",
                table: "SettlementAllocations",
                columns: new[] { "TransactionId", "DebtorUserId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Settlements_PayerUserId_PayeeUserId",
                table: "Settlements",
                columns: new[] { "PayerUserId", "PayeeUserId" });
